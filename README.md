...
The Meta Quest controller models used during development have also been removed, as they are Meta's asset. The VRPawn character class references two controller meshes named Controller_L and Controller_R, left empty in this version. Any controller mesh can be assigned to these slots to restore the visual, the originals are available from Meta's controller art package linked below.

[Meta Quest Controller Models](https://developers.meta.com/horizon/downloads/package/oculus-controller-art/) by Meta

## Third-Party Credits

- [Sci-Fi Gun](https://sketchfab.com/3d-models/sci-fi-gun-82ea4530b9a44829967bcd6f699aae49) by chanmagomed (Sketchfab, CC BY 4.0)
- Game UI Font is [Orbitron](https://fonts.google.com/specimen/Orbitron), distributed through Google Fonts under the SIL Open Font License 1.1
- Voice overs, background music, and SFX generated with [ElevenLabs](https://elevenlabs.io/) under a paid subscription

See `NOTICE.md` for the full third-party attribution.
